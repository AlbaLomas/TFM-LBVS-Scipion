...
class ProtocolChemblAccession(EMProtocol):
    ...
    _moleculetypeChoices = ['SINGLE PROTEIN', 'CHIMERIC PROTEIN', 'PROTEIN FAMILY', 'PROTEIN-PROTEIN INTERACTION']
    _assaytypeChoices = ['(B) Binding', '(F) Functional', '(A) ADMET', '(T) Toxicity', '(P) Physicochemical', '(U) Unclassified']
    _relationChoices = ['=']
    ...
    def _defineParams(self, form):
        ...
        group.addParam('moleculetypeChoice', params.EnumParam, default=0, label='Target type: ',
                       choices=self._moleculetypeChoices,
