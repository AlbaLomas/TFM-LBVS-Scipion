...
scriptName = 'pains_rdkit_script.py'
...
class ProtocolPainsRdkitFiltering(EMProtocol):
    ...
    def createOutputStep(self):
        ...
        newMols = SetOfSmallMolecules.createCopy(self.inputSmallMolecules.get(), self._getPath(), suffix='consensusSmallMolecules{}', copyInfo=True)
        ...
        if not self.painsFile.get():
            ...
            self._defineOutputs(SmallMoleculesCleaned=newMols,SmallMoleculesPains=newMols2)
